      ...
      <el-card class="card_content" shadow="never">
        <el-form ref="form" :model="form" label-width="100px">
          ...
          <el-form-item label="修改密码">
            <el-row>
              <el-col :span="12"><el-input v-model="form.password1" placeholder="新密码" style="width: 100%"></el-input></el-col>
              <el-col :span="12"></el-col>
            </el-row>
            <el-row>
              <el-col :span="12"><el-input v-model="form.password2" placeholder="请再次输入" style="width: 100%"></el-input></el-col>
              <el-col :span="12"> <el-button type="primary" @click="change_password()">修改</el-button></el-col>
            </el-row>
          </el-form-item>
          <el-form-item>
            <el-row>
              <el-col :span="12"><el-button type="primary" @click="delete_user()">注销该用户</el-button></el-col>
...
export default {
  ...
  methods: {
    ...
    async change_password(){
      if(this.form.password2===this.form.password1){//此处password1与password2有问题，应该要修改
        axios
            .post("/users", {
              user_id: this.user_id,
